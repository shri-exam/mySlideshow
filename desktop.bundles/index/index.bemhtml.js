  ...
  var cache,
    ...
    function apply() {
        ...
        if (__t === "content") {
            var __t = this.block;
            if (__t === "progressbar") {
                if (this.elem === "loading") {
                    return "Загружаю фотки. Секундочку ..";
                    return;
                } else {
                    return $19.call(this);
                }
            } else if (__t === "autoplay") {
                if (!!this.elem === false) {
                    return "Автопроигрывание";
                    return;
                } else {
                    return $19.call(this);
                }
            ...
            if (__t === "progressbar") {
                ...
                var __t = this.elem;
                if (__t === "count-photos" || __t === "current-photo") {
                    return "b";
                    return;
                } else if (__t === "title-name") {
                    return "span";
                    return;
                } else {
                    return $62.call(this);
    ...
    function $116() {
        if (!(this["__$anflg"] !== 42549313) === false) {
            if (!!this.elem === false) {
